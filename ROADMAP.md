...
- Final strategy decision: cascade+funding opportunistic entry (rare, ~2 trades/180 days), 1% risk per trade, tp/sl attached, 950 USDT circuit breaker (was 900). Simulated result: +0.53% over 180 days, near-zero drawdown, capital-preservation focused given no provable directional edge exists.
...
- Risk hardening (pre-July 20; entry signal unchanged): (1) equity-floor circuit breaker raised 900 -> 950 USDT; (2) new UTC daily-loss breaker pauses new entries if equity falls >5% below that UTC day's starting equity; (3) EFFECTIVE_LEVERAGE=1.5x for position sizing while account API leverage stays at 2x cap; (4) real-AI prompt weights PAUSE more under abnormal cross-market / high-volume stress; (5) verify_audit_completeness.py checks ai_decisions.log vs audit/*.jsonl field completeness.
